...
import { PRICING, AGENCIES_FEATURES, AGENCIES_FAQ, SIGNUP_LIVE } from "@/lib/constants";
    ...
    <>
      ...
      <section className="py-24 px-6">
        <div className="max-w-md mx-auto text-center mb-6">
          <h1 className="text-4xl font-serif text-navy mb-4">Pricing</h1>
        </div>
        ...
        <p className="text-center text-navy/50 text-sm mt-8 max-w-md mx-auto">
          Document retrieval. Source attribution. Data sovereignty. No engineering judgment.
        </p>
      </section>

      <section className="max-w-2xl mx-auto px-6 pb-24">
        <h2 className="text-2xl font-serif text-navy text-center mb-10">
