...
import PraxisPrincipal from "./PraxisPrincipal";
import PraxisPE from "./PraxisPE";
import PraxisPM from "./PraxisPM";
import PraxisEIT from "./PraxisEIT";
...
const DEMOS = [
  { id: "principal", label: "The Principal", subtitle: "\"What needs my attention?\"", duration: 29, Component: PraxisPrincipal },
  { id: "pe", label: "The PE", subtitle: "\"I need to sign this\"", duration: 31, Component: PraxisPE },
  { id: "pm", label: "The PM", subtitle: "\"Where are we really?\"", duration: 27, Component: PraxisPM },
  { id: "eit", label: "The EIT", subtitle: "\"How do I check this?\"", duration: 28, Component: PraxisEIT },
];

export default function PraxisDemoCarousel() {
